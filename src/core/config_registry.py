...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "WECHAT_MSG_TYPE": {
        ...
        "description": "Enterprise WeChat bot message type. Default markdown_v2 uses the current WeChat Work Markdown payload.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "WECHAT_MAX_BYTES": {
        ...
        "description": "Maximum bytes per enterprise WeChat message before chunking. Defaults to 4000 for markdown_v2/markdown and 2048 for text.",
        "category": "notification",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
